...
const configs = [
  ...
  { ignores: ["*.less.d.ts"], files: ["src/**/*.ts", "test/**/*.ts"] },
  {
    ...
    rules: {
      ...
      "import/no-extraneous-dependencies": ["warn", { devDependencies: ["**/*.spec.ts", "test/**/*.ts"] }],
      "import/no-internal-modules": ["error"],
      "filenames/match-regex": ["error", "^[a-z]{1}[a-zA-Z-_.]+$|^[0-9]+_[a-z]{1}[0-9a-zA-Z-_.]+$", true],
    },
  },
  {
    rules: {
      ...
      "@typescript-eslint/naming-convention": [
        ...
        {
          selector: ["interface", "class", "typeAlias", "enum", "typeParameter"],
          format: ["PascalCase"],
        },
        {
          selector: ["enumMember"],
